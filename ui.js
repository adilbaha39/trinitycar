  ...
  <header class="sticky top-0 z-50 bg-[#F3F1EC]/90 backdrop-blur border-b border-black/5">
    <div id="navInner" class="max-w-7xl mx-auto px-5 md:px-8 h-20 flex items-center justify-between">
      <a href="index.html" class="flex flex-col leading-none group" aria-label="Trinity Car - ${T.nav.home}">
        <svg width="150" height="18" viewBox="0 0 150 18" fill="none" class="mb-1 opacity-70"><path class="svg-draw" d="M2 15c8-10 20-13 35-10s25 8 40 3 35-6 45 2" stroke="#1E5FBF" stroke-width="1.2" fill="none"/></svg>
        <span class="text-2xl font-black tracking-tight text-slate-900 navbar-logo-text">TRINITY<span class="text-blue-600">CAR</span></span>
