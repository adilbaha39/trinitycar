...
function renderNavbar() {
  ...
  <header class="sticky top-0 z-50 bg-[#F3F1EC]/90 backdrop-blur border-b border-black/5">
    <div id="navInner" class="max-w-7xl mx-auto px-5 md:px-8 h-20 flex items-center justify-between">
      <!-- NEW LOGO START -->
      <a href="index.html" class="flex items-center gap-3 group" aria-label="Trinity Car - ${T.nav.home}">
        <!-- SVG Car Line Art -->
        <svg width="60" height="45" viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
          <path d="M10 50 L15 30 L35 18 L75 18 L100 35 L110 50" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M15 30 L35 18 L75 18 L100 35" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M20 50 C20 50, 30 55, 40 50 C50 45, 60 55, 70 50 C80 45, 90 55, 100 50" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
          <circle cx="35" cy="55" r="8" stroke="white" stroke-width="2.5"/>
          <circle cx="85" cy="55" r="8" stroke="white" stroke-width="2.5"/>
        ...
        <div class="flex flex-col leading-none">
          ...
          <span class="text-[8px] tracking-[0.3em] text-gray-300 font-medium">LOCATION DE VOITURE</span>
        </div>
      </a>
      <!-- NEW LOGO END -->
