...
const CARS = [
  ...
  },
  {
    id: "opel-corsa-blue",
    name: "Opel Corsa",
    trim: { fr: "Essence, Bleue", ar: "بنزين، زرقاء", en: "Petrol, Blue" },
    year: 2021,
    pricePerDay: 300,
  ...
  {
    id: "hyundai-accent-white-2",
    name: "Hyundai Accent",
    trim: { fr: "Essence Automatique, Blanche (2)", ar: "بنزين أوتوماتيكية، بيضاء (2)", en: "Petrol Automatic, White (2)" },
    year: 2024,
    pricePerDay: 350,
    gearbox: { fr: "Automatique", ar: "أوتوماتيكية", en: "Automatic" },
    seats: 5,
